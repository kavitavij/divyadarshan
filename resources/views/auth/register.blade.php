...
@section('title', 'Register - DivyaDarshan')
...
@section('content')
    <div class="min-h-screen flex relative overflow-hidden">
        ...
        <div class="hidden lg:flex lg:w-1/2 gradient-bg p-12 flex-col justify-between relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <div class="max-w-lg">
                    <h1 class="text-white text-5xl font-bold mb-6 leading-tight"> Join DivyaDarshan Today </h1>
                ...
                <div class="bg-white bg-opacity-80 backdrop-blur-sm rounded-lg card-shadow overflow-hidden border-0">
                    ...
                    <div class="p-8 pt-8 pb-6">
                        <div class="text-center lg:text-left mb-6">
                            <h2 class="text-gray-900 text-3xl mb-2 font-bold">Create Your Account</h2>
                            <p class="text-gray-600 text-base">Get started with your DivyaDarshan account</p>
                        </div>
                        ...
                        <a href="{{ route('google.redirect') }}" {{-- Make sure 'google.redirect' is your correct route name --}}
                            ...
                            <span class="relative z-10 group-hover:text-gray-900">Sign up with Google</span>
                        </a>
                        <div class="relative mb-6">
                            ...
                            <div class="relative flex justify-center text-xs uppercase"> <span
                                    class="bg-white px-3 text-gray-500 font-medium">Or continue with email</span> </div>
                        </div>
                        <form method="POST" action="{{ route('register') }}" class="space-y-4">
                            ...
                            <div>
                                <label for="name" class="block text-sm font-medium text-gray-700 mb-2">Full
                                    Name</label>
                                <div class="relative group"> <input type="text" id="name" name="name"
                            ...
                            <div>
                                <label for="email" class="block text-sm font-medium text-gray-700 mb-2">Email
                                    Address</label>
                                <div class="relative group"> <input type="email" id="email" name="email"
                                        value="{{ old('email') }}" required
                                        class="input-focus block w-full px-3 pr-3 py-3 h-12 border border-gray-300 rounded-lg focus:outline-none transition-all text-gray-900"
                                        placeholder="name@gmail.com"> </div>
                                @error('email')
                                    <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                                @enderror
                            </div>
                            <div>
                                ...
                                <div class="relative group"> <input type="password" id="password" name="password"
                                        required
                                        ...
                                        placeholder="Create a strong password"> <button type="button"
                            ...
                            <div>
                                ...
                                <div class="relative group"> <input type="password" id="password_confirmation"
                                        name="password_confirmation" required
                                        class="input-focus block w-full px-3 pr-11 py-3 h-12 border border-gray-300 rounded-lg focus:outline-none transition-all text-gray-900"
                                        placeholder="Confirm your password"> <button type="button"
                            ...
                            <div class="flex items-start">
                                <label class="flex items-center group cursor-pointer">
                                    ...
                                    <span class="ml-2 text-sm text-gray-600 group-hover:text-gray-900 transition-colors"> I
                                        agree to the <a href="#" onclick="openModal('terms')"
                                            class="text-blue-600 hover:text-blue-700 font-medium hover:underline">Terms</a>
                                        and <a href="#" onclick="openModal('privacy')"
    ...
    <div id="termsModal" class="fixed inset-0 z-50 hidden overflow-y-auto">
        <div class="min-h-screen px-4 text-center">
            <div class="fixed inset-0 bg-gray-900 bg-opacity-50 transition-opacity" onclick="closeModal('terms')"></div>
            <div
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="flex justify-between items-start pb-3 border-b border-gray-200">
                        ...
                        <button onclick="closeModal('terms')" class="text-gray-400 hover:text-gray-500">
                    ...
                    <div class="mt-4 prose max-w-none">
                        {!! $settings['page_content_terms'] ?? 'Terms and conditions not available.' !!}
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="privacyModal" class="fixed inset-0 z-50 hidden overflow-y-auto">
        <div class="min-h-screen px-4 text-center">
            <div class="fixed inset-0 bg-gray-900 bg-opacity-50 transition-opacity" onclick="closeModal('privacy')"></div>
            <div
                class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="flex justify-between items-start pb-3 border-b border-gray-200">
                        <h3 class="text-lg font-semibold text-gray-900">Privacy Policy</h3>
                        <button onclick="closeModal('privacy')" class="text-gray-400 hover:text-gray-500">
                            <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M6 18L18 6M6 6l12 12" />
                            </svg>
                    ...
                    <div class="mt-4 prose max-w-none">
                        {!! $settings['page_content_privacy'] ?? 'Privacy policy not available.' !!}
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        // Removed registerWithGoogle function
    </script>
@endsection
