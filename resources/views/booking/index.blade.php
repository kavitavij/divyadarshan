...
<style>
    ...
    .dark .stepper-item::after {
        border-bottom-color: #374151; /* dark mode line color */
    }
    ...
    .dark .slot-item.selected { background-color: #312e81; }
    ...
    .dark .slot-time { color: #f9fafb; }
    .slot-item.selected .slot-time { color: #312e81; }
    .dark .slot-item.selected .slot-time { color: #c7d2fe; }
    .slot-availability {
        font-size: 0.9rem;
        font-weight: 500;
    ...
    <div class="flex justify-center">
        <div class="w-full lg:w-10/12">
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
                ...
                <div class="p-6">
                    <div class="mb-4">
                        <label for="temple_id" class="block font-semibold mb-2 text-gray-800 dark:text-gray-200">1. Select Temple</label>
                        <select name="temple_id" id="temple_id" class="form-control dark:bg-gray-700 dark:text-gray-200" required>
                    ...
                    <form id="bookingForm" action="{{ route('booking.details') }}" method="GET">
                        ...
                        <div class="mb-4">
                            <label for="darshan_date" class="block font-semibold mb-2 text-gray-800 dark:text-gray-200">2. Select Darshan Date</label>
                            <input type="date" id="darshan_date" name="selected_date" class="form-control dark:bg-gray-700 dark:text-gray-200" required>
                        </div>

                        <div class="mb-4">
                            <label class="block font-semibold mb-2 text-gray-800 dark:text-gray-200">3. Select a Time Slot</label>
                            <div id="slots-loader" style="display: none;"><span class="text-gray-800 dark:text-gray-300">Loading slots...</span></div>
                        ...
                        <div class="mb-4">
                            <label for="number_of_people" class="block font-semibold mb-2 text-gray-800 dark:text-gray-200">4. Number of People</label>
                            <input type="number" name="number_of_people" id="number_of_people" class="form-control dark:bg-gray-700 dark:text-gray-200" value="1" min="1" max="8" required>
                        </div>
