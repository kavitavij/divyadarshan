            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card summary-card">
                        ...
                        <div class="card-body">
                            <h3 class="text-xl font-semibold mb-3 text-center">Please confirm your details before
                                proceeding to payment.</h3>
                            ...
                            <div class="details-box mb-4">
                                ...
                                <p><strong>Status:</strong> <span
                                        class="badge bg-warning text-dark">{{ $booking->status }}</span></p>
                            </div>
