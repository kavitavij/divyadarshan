...
<div class="mb-12 px-4">
  <h2 class="text-2xl font-bold text-center text-blue-700 mb-6"> ePublication</h2>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 px-4 mt-6">
        @forelse ($books as $book)
            <div class="bg-white p-4 rounded shadow hover:shadow-lg transition text-center">
                <img src="{{ asset('images/temples/' . $book['cover']) }}"
                alt="{{ $book['title'] }}"
                ...
                <a href="{{ asset('images/temples/ebooks/' . $book['file']) }}" target="_blank">
                    📖 Read / Download
                </a>
            </div>
        @empty
