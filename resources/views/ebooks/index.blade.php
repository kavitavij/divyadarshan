...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        <div
            class="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6 mb-8 p-4 bg-white dark:bg-gray-900 rounded-lg shadow-md">
        ...
        @else
            ...
            <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                @foreach ($ebooks as $ebook)
                    <div
                        class="card bg-white dark:bg-gray-900 shadow-lg rounded-lg overflow-hidden flex flex-col transition-transform duration-300 hover:-translate-y-2">
                        <div class="relative">
                                ...
                                @if ($ebook->type == 'paid')
                                    <div class="mb-2">
                                        @if ($ebook->discount_percentage > 0)
                                            ...
                                            <span
                                                class="text-xs font-semibold text-green-800 bg-green-200 px-2 py-0.5 rounded-full">
