            ...
            <form action="{{ route('hotel-manager.rooms.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="field">
                    ...
                    <div class="photo-uploader" onclick="document.getElementById('photos').click()">
                        ...
                        <input type="file" name="photos[]" id="photos" class="control" multiple accept="image/*"
                            style="display: none;">
                    </div>
                ...
                <div class="row-3">
                    <div class="field">
                        ...
                        <input type="number" name="price_per_night" id="price_per_night" class="control" step="0.01"
                    ...
                    <div class="field">
                        ...
                        <input type="number" name="discount_percentage" id="discount_percentage" class="control"
                            step="0.01" value="{{ old('discount_percentage') }}" min="0" max="100">
                ...
                <div class="row-3">
                    <div class="field">
                        ...
                        <input type="number" name="capacity" id="capacity" class="control" value="{{ old('capacity') }}"
                            required>
                        @error('capacity')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="field">
                        ...
                        <input type="number" name="total_rooms" id="total_rooms" class="control"
                    ...
                    <div class="field">
                        ...
                        <input type="number" name="room_size" id="room_size" class="control"
                            value="{{ old('room_size') }}">
                        @error('room_size')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="facilities-grid">
                        @foreach ($facilities as $facility)
                            <div class="facility-item">
                                ...
                                <label
                                    for="facility_{{ \Illuminate\Support\Str::slug($facility) }}">{{ $facility }}</label>
                            </div>
                        @endforeach
                    </div>
                    @error('facilities')
