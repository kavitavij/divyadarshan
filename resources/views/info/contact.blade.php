        ...
        <div class="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                <p class="text-gray-600 mb-4">
                    We are here to help you with any questions or support you may need for your spiritual journey. Please
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                {{-- THE FIX: Added blocks to show success and error messages --}}
                @if (session('success'))
