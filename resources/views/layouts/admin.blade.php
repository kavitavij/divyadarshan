...
<body>
    <nav class="sidebar" id="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li><a class="nav-link {{ request()->routeIs('admin.settings.*') ? 'active' : '' }}" href="{{ route('admin.settings.edit') }}">
                <i class="fa-solid fa-file-alt"></i> <span>Page Content</span></a></li>

            <li><a class="nav-link {{ request()->routeIs('admin.contact-submissions.*') ? 'active' : '' }}" href="{{ route('admin.contact-submissions.index') }}">
                <i class="fa-solid fa-envelope"></i> <span>Contact Forms</span></a></li>

            <li><a class="nav-link {{ request()->routeIs('admin.latest_updates.*') ? 'active' : '' }}" href="{{ route('admin.latest_updates.index') }}">
            ...
            <li><a class="nav-link {{ request()->routeIs('admin.ebooks.*') ? 'active' : '' }}" href="{{ route('admin.ebooks.index') }}">
                <i class="fa-solid fa-book"></i> <span>Ebooks</span></a></li>

            <li><a class="nav-link {{ request()->routeIs('admin.spiritual-help.index') ? 'active' : '' }}" href="{{ route('admin.spiritual-help.index') }}">
            ...
            <li><a class="nav-link {{ request()->routeIs('admin.donations.*') ? 'active' : '' }}" href="{{ route('admin.donations.index') }}">
            ...
            <li><a class="nav-link {{ request()->routeIs('admin.amenities.index') ? 'active' : '' }}" href="{{ route('admin.amenities.index') }}">
            ...
            <li><a class="nav-link {{ request()->routeIs('admin.booking-cancel.*') ? 'active' : '' }}" href="{{ route('admin.booking-cancel.index') }}">
