...
<head>
    ...
    <style>
        body { display: flex; }
        .sidebar { width: 280px; height: 100vh; position: fixed; top: 0; left: 0; background-color: #f8f9fa; padding-top: 20px; }
        .main-content { margin-left: 280px; padding: 20px; width: 100%; }
    </style>
</head>
<body>
