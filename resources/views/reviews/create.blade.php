        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl overflow-hidden">
            <div class="p-8">
                ...
                <p class="text-center text-gray-600 dark:text-gray-400 mb-6">
                    Share your experience for your stay at <strong class="text-yellow-500">{{ $stayBooking->room->hotel->name }}</strong>.
                </p>
                ...
                <form action="{{ route('reviews.store', ['stayBooking' => $stayBooking]) }}" method="POST">
                    ...
                    {{-- Star Rating Input --}}
                    <div class="mb-8">
                        <label class="block text-lg font-semibold text-gray-700 dark:text-gray-300 text-center mb-3">Your Rating</label>
                        <div class="star-rating">
                            <input type="radio" id="star5" name="rating" value="5" {{ old('rating') == 5 ? 'checked' : '' }} required /><label for="star5" title="5 stars">★</label>
                    ...
                    {{-- Comment Textarea --}}
                    <div class="mb-6">
                        <label for="comment" class="block text-lg font-semibold text-gray-700 dark:text-gray-300 mb-2">Your Review</label>
                        <textarea name="comment" id="comment" rows="6" class="w-full px-4 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-gray-900 dark:text-gray-200" placeholder="Tell us about your stay...">{{ old('comment') }}</textarea>
                    </div>
