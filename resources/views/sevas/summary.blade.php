            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h2>Seva Booking Summary</h2>
                    </div>
                    <div class="card-body">
                        <h3 class="text-xl font-semibold mb-3">Please confirm your Seva details before proceeding to payment.
                        </h3>
                        ...
                        <div class="border rounded-lg p-4">
                            ...
                            <p><strong>Status:</strong> <span
                                    class="badge bg-warning text-dark">{{ $sevaBooking->status }}</span></p>
                        </div>
