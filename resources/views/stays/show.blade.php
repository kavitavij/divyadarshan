...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            <img src="{{ $hotel->image ? asset($hotel->image) : 'https://placehold.co/800x500/EBF4FF/7F9CF5?text=Hotel' }}" alt="{{ $hotel->name }}" class="w-full rounded-lg shadow-md mb-6">
                ...
                <div class="space-y-4">
                    @forelse($hotel->rooms as $room)
                        <div class="border rounded-lg p-4">
                            ...
                            <p class="text-xl font-semibold text-blue-700 mt-2">₹{{ number_format($room->price_per_night, 2) }} <span class="text-sm font-normal text-gray-500">/ night</span></p>
                            <div class="mt-3">
                                {{-- This will eventually lead to the booking form --}}
                                <a href="#" class="btn btn-success w-full">Book Now</a>
                            </div>
                        </div>
                    @empty
